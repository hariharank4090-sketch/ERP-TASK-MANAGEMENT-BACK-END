...
exports.getParamMasterStatistics = exports.hardDeleteParamMaster = exports.restoreParamMaster = exports.deleteParamMaster = exports.updateParamMaster = exports.createParamMaster = exports.getAllActiveParamMasters = exports.getParamMastersByCompanyId = exports.getParamMasterById = exports.getAllParamMasters = void 0;
const sequelize_1 = require("sequelize");
const zod_1 = require("zod");
const responseObject_1 = require("../../../responseObject");
const type_model_1 = require("../../../models/masters/parametMaster/type.model");
const type_model_2 = require("../../../models/masters/parametMaster/type.model");
...
const getParamMasterModel = (req) => {
    const sequelize = req.companyDB;
    if (!sequelize) {
        throw new Error('Database connection not available');
    }
    return (0, type_model_2.initParamMasterModel)(sequelize);
};
 ...
 */
const getAllParamMasters = async (req, res) => {
    try {
        ...
        const validation = validateWithZod(type_model_1.ParamMasterQuerySchema, req.query);
        ...
        const { search, companyId, sortBy = 'Paramet_Id', sortOrder = 'ASC' } = validation.data;
        // Build where clause
        const whereClause = {
            Del_Flag: 0
        };
        ...
        if (search) {
            whereClause.Paramet_Name = { [sequelize_1.Op.like]: `%${search}%` };
        }
...
exports.getAllParamMasters = getAllParamMasters;
/**
 * Get parameter master by ID
 */
const getParamMasterById = async (req, res) => {
    try {
        // Check authentication
        if (!checkUserPermission(req, 'view_parammaster')) {
            return handleForbiddenError(res, 'You do not have permission to view parameter masters');
        ...
        const validation = validateWithZod(type_model_1.paramMasterIdSchema, { id: parseInt(req.params.id) });
        if (!validation.success) {
            return res.status(400).json({
                success: false,
                message: 'Validation failed',
        ...
        if (!paramMaster) {
            return (0, responseObject_1.notFound)(res, 'Parameter master not found');
        }
...
exports.getParamMasterById = getParamMasterById;
/**
 * Get parameter masters by company ID
 */
const getParamMastersByCompanyId = async (req, res) => {
    try {
        // Check authentication
        if (!checkUserPermission(req, 'view_parammaster')) {
            return handleForbiddenError(res, 'You do not have permission to view parameter masters');
...
exports.getParamMastersByCompanyId = getParamMastersByCompanyId;
/**
 * Get active parameter masters
 */
const getAllActiveParamMasters = async (req, res) => {
    try {
        // Check authentication
        if (!checkUserPermission(req, 'view_parammaster')) {
            return handleForbiddenError(res, 'You do not have permission to view parameter masters');
...
exports.getAllActiveParamMasters = getAllActiveParamMasters;
/**
 * Create new parameter master
 */
const createParamMaster = async (req, res) => {
    try {
        ...
        const validation = validateWithZod(type_model_1.ParamMasterCreationSchema, req.body);
        if (!validation.success) {
            return res.status(400).json({
                success: false,
                message: 'Validation failed',
...
exports.createParamMaster = createParamMaster;
/**
 * Update parameter master
 */
const updateParamMaster = async (req, res) => {
    try {
        // Check authentication and permission
        ...
        const ParamMaster = getParamMasterModel(req);
        // Validate ID parameter
        const idValidation = validateWithZod(type_model_1.paramMasterIdSchema, { id: parseInt(req.params.id) });
        ...
        // Validate request body
        const bodyValidation = validateWithZod(type_model_1.ParamMasterUpdateSchema, req.body);
        ...
        if (updateData.Paramet_Name && updateData.Paramet_Name !== paramMaster.Paramet_Name) {
            const existingParamMaster = await ParamMaster.findOne({
                where: {
                    Paramet_Id: { [sequelize_1.Op.ne]: id },
        ...
        if (updateData.Paramet_Name !== undefined)
            finalUpdateData.Paramet_Name = updateData.Paramet_Name.trim();
        if (updateData.Paramet_Data_Type !== undefined)
            finalUpdateData.Paramet_Data_Type = updateData.Paramet_Data_Type;
        if (updateData.Company_id !== undefined)
            finalUpdateData.Company_id = updateData.Company_id;
        if (updateData.Del_Flag !== undefined)
            finalUpdateData.Del_Flag = updateData.Del_Flag;
        ...
        if (!updatedParamMaster) {
            return (0, responseObject_1.notFound)(res, 'Parameter master not found after update');
        }
        const formattedParamMaster = {
...
exports.updateParamMaster = updateParamMaster;
/**
 * Delete parameter master (soft delete)
 */
const deleteParamMaster = async (req, res) => {
    try {
        // Check authentication and permission
...
exports.deleteParamMaster = deleteParamMaster;
/**
 * Restore parameter master (undo soft delete)
 */
const restoreParamMaster = async (req, res) => {
    try {
        // Check authentication and permission
        if (!checkUserPermission(req, 'update_parammaster')) {
        ...
        if (!restoredParamMaster) {
            return (0, responseObject_1.notFound)(res, 'Parameter master not found after restore');
        }
        const formattedParamMaster = {
...
exports.restoreParamMaster = restoreParamMaster;
/**
 * Hard delete parameter master (permanent delete)
 */
const hardDeleteParamMaster = async (req, res) => {
    try {
...
exports.hardDeleteParamMaster = hardDeleteParamMaster;
/**
 * Get parameter master statistics
 */
const getParamMasterStatistics = async (req, res) => {
    try {
        // Check authentication
        if (!checkUserPermission(req, 'view_parammaster')) {
...
exports.getParamMasterStatistics = getParamMasterStatistics;
