...
const user_controller_1 = require("../../controllers/Attendace/user.controller");
 ...
 */
router.get('/', auth_1.authenticate, (0, auth_1.authorize)([1, 2]), user_controller_1.getAllUsers);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/dropdown', auth_1.authenticate, user_controller_1.getUserDropdown);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', auth_1.authenticate, (0, auth_1.authorize)([1, 2]), user_controller_1.getUserById);
/**
 * @swagger
 * /api/attendance/users:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)([1, 2]), user_controller_1.createUser);
/**
 * @swagger
 * /api/attendance/users/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)([1, 2]), user_controller_1.updateUser);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.put('/:id/change-password', auth_1.authenticate, user_controller_1.changePassword);
/**
 * @swagger
 * /api/attendance/users/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)([1]), user_controller_1.deleteUser);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete('/:id/hard', auth_1.authenticate, (0, auth_1.authorize)([1]), user_controller_1.hardDeleteUser);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.put('/:id/restore', auth_1.authenticate, (0, auth_1.authorize)([1, 2]), user_controller_1.restoreUser);
