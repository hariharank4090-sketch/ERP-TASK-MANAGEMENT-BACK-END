...
const taskParamType_controller_1 = require("../../controllers/masters/taskManagement/taskParamType.controller");
 ...
 */
router.get('/statistics', auth_1.authenticate, (0, auth_1.authorize)([]), taskParamType_controller_1.getParametDataTypeStatistics);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/search', auth_1.authenticate, (0, auth_1.authorize)([]), taskParamType_controller_1.searchParametDataTypes);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/active', auth_1.authenticate, (0, auth_1.authorize)([]), taskParamType_controller_1.getAllActiveParametDataTypes);
// ==================== CRUD OPERATIONS ====================
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/', auth_1.authenticate, (0, auth_1.authorize)([]), taskParamType_controller_1.getAllParametDataTypes);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), taskParamType_controller_1.getParametDataTypeById);
/**
 * @swagger
 * /api/masters/parametDataTypes:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)([]), taskParamType_controller_1.createParametDataType);
/**
 * @swagger
 * /api/masters/parametDataTypes/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), taskParamType_controller_1.updateParametDataType);
/**
 * @swagger
 * /api/masters/parametDataTypes/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), taskParamType_controller_1.deleteParametDataType);
