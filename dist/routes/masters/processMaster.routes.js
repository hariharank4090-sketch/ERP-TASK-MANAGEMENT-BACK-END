...
const processMaster_controller_1 = require("../../controllers/masters/taskManagement/processMaster.controller");
 ...
 */
router.get('/statistics', auth_1.authenticate, (0, auth_1.authorize)([]), processMaster_controller_1.getProcessStatistics);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/all', auth_1.authenticate, (0, auth_1.authorize)([]), processMaster_controller_1.getAllProcessesSimple);
// ==================== CRUD OPERATIONS ====================
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/', auth_1.authenticate, (0, auth_1.authorize)([]), processMaster_controller_1.getAllProcessMaster);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), processMaster_controller_1.getProcessMasterById);
/**
 * @swagger
 * /api/masters/processMaster:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)([]), processMaster_controller_1.createProcessMaster);
/**
 * @swagger
 * /api/masters/processMaster/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), processMaster_controller_1.updateProcessMaster);
/**
 * @swagger
 * /api/masters/processMaster/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), processMaster_controller_1.deleteProcessMaster);
