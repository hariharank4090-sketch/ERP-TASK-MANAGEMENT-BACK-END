...
const projectScedule_controller_1 = require("../../controllers/masters/taskManagement/projectScedule.controller");
 ...
 */
router.get('/', projectScedule_controller_1.getAllSchedules);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/dropdown', projectScedule_controller_1.getScheduleDropdown);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/plans/dropdown', projectScedule_controller_1.getSchedulePlansDropdown);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/tasks/dropdown', projectScedule_controller_1.getTasksDropdown);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/types/dropdown', projectScedule_controller_1.getScheduleTypesDropdown);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', projectScedule_controller_1.getScheduleById);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id/details', projectScedule_controller_1.getScheduleDetails);
/**
 * @swagger
 * /api/masters/projectSchedule:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)([]), projectScedule_controller_1.createSchedule);
/**
 * @swagger
 * /api/masters/projectSchedule/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), projectScedule_controller_1.updateSchedule);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.patch('/:id/status', auth_1.authenticate, (0, auth_1.authorize)([]), projectScedule_controller_1.updateScheduleStatus);
/**
 * @swagger
 * /api/masters/projectSchedule/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), projectScedule_controller_1.deleteSchedule);
