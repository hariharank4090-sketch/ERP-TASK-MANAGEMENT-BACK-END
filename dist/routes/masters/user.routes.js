...
const dbuser_controller_1 = require("../../controllers/masters/taskManagement/dbuser.controller");
const sequalizer_1 = require("../../config/sequalizer");
const router = express_1.default.Router();
// Apply middleware to all routes in this router
router.use(sequalizer_1.sequelizeFromTokenMiddleware);
/**
 * @swagger
 * tags:
 *   name: Users
 ...
 */
router.get('/test', dbuser_controller_1.testConnection);
/**
 * @swagger
 * /api/masters/users:
 *   get:
 ...
 */
router.get('/', dbuser_controller_1.getAllUsers);
/**
 * @swagger
 ...
 */
router.get('/deleted', dbuser_controller_1.getDeletedUsers);
/**
 * @swagger
 ...
 */
router.get('/dropdown', dbuser_controller_1.getUserDropdown);
/**
 * @swagger
 ...
 */
router.get('/company/:companyId', dbuser_controller_1.getUsersByCompany);
/**
 * @swagger
 ...
 */
router.get('/branch/:branchId', dbuser_controller_1.getUsersByBranch);
/**
 * @swagger
 ...
 */
router.get('/type/:userTypeId', dbuser_controller_1.getUsersByType);
/**
 * @swagger
 ...
 */
router.get('/:id', dbuser_controller_1.getUserById);
