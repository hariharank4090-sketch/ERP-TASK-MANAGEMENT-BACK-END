...
const employeemaster_controller_1 = require("../../controllers/masters/taskManagement/employeemaster.controller");
 ...
 */
router.get('/', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getAllEmployees);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/active', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getActiveEmployees);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/statistics', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getEmployeeStatistics);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/search', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.searchEmployees);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/count', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getEmployeeCount);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/salary-range', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getEmployeesBySalaryRange);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/branch/:branchId', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getEmployeesByBranch);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/department/:departmentId', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getEmployeesByDepartment);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getEmployeeById);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/code/:empCode', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.getEmployeeByCode);
 ...
 *         description: Internal server error
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.createEmployee);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/bulk', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.bulkCreateEmployees);
/**
 * @swagger
 * /api/masters/employees/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.updateEmployee);
/**
 * @swagger
 * /api/masters/employees/{id}:
 *   patch:
 ...
 *         description: Internal server error
 */
router.patch('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.partialUpdateEmployee);
/**
 * @swagger
 * /api/masters/employees/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), employeemaster_controller_1.deleteEmployee);
