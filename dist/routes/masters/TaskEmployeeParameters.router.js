...
const TaskEmployeeParameters_controller_1 = require("../../controllers/masters/taskManagement/TaskEmployeeParameters.controller");
 ...
 */
router.get('/', auth_1.authenticate, (0, auth_1.authorize)([]), TaskEmployeeParameters_controller_1.getAllTaskParametDTs);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/byTask/:taskId', auth_1.authenticate, (0, auth_1.authorize)([]), TaskEmployeeParameters_controller_1.getTaskParametDTsByTaskId);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), TaskEmployeeParameters_controller_1.getTaskParametDTById);
// ==================== CRUD OPERATIONS ====================
/**
 * @swagger
 * /api/masters/taskParameterDetails:
 ...
 *         description: Internal server error
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)([]), TaskEmployeeParameters_controller_1.createTaskParametDT);
/**
 * @swagger
 * /api/masters/taskParameterDetails/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), TaskEmployeeParameters_controller_1.updateTaskParametDT);
/**
 * @swagger
 * /api/masters/taskParameterDetails/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), TaskEmployeeParameters_controller_1.deleteTaskParametDT);
/**
 * @swagger
 * /api/masters/taskParameterDetails/byTask/{taskId}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/byTask/:taskId', auth_1.authenticate, (0, auth_1.authorize)([]), TaskEmployeeParameters_controller_1.deleteTaskParametDTsByTaskId);
