...
const projectScheduleEmp_controller_1 = require("../../controllers/masters/taskManagement/projectScheduleEmp.controller");
 ...
 */
router.post('/create', projectScheduleEmp_controller_1.createTaskDetailsRaw);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.put('/bulk-update', projectScheduleEmp_controller_1.updateTaskDetailsBulk);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/list', projectScheduleEmp_controller_1.getAllTaskDetails);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/filter', projectScheduleEmp_controller_1.getTaskDetailsWithFilters);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/statistics/all', projectScheduleEmp_controller_1.getTaskDetailsStatistics);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/project/:projectId', projectScheduleEmp_controller_1.getTaskDetailsByProject);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/schedule/:schId', projectScheduleEmp_controller_1.getTaskDetailsBySchedule);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/task/:taskId', projectScheduleEmp_controller_1.getTaskDetailsByTask);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/employee/:empId', projectScheduleEmp_controller_1.getTaskDetailsByEmployee);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', projectScheduleEmp_controller_1.getTaskDetailById);
/**
 * @swagger
 * /api/masters/projectScheduleEmp/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', projectScheduleEmp_controller_1.updateTaskDetail);
/**
 * @swagger
 * /api/masters/projectScheduleEmp/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', projectScheduleEmp_controller_1.deleteTaskDetail);
