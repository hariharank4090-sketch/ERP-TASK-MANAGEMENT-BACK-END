...
const leaveType_controller_1 = require("../../controllers/masters/taskManagement/leaveType.controller");
 ...
 */
router.get('/', leaveType_controller_1.getAllLeaveTypes);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/dropdown', leaveType_controller_1.getLeaveTypeDropdown);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', leaveType_controller_1.getLeaveTypeById);
/**
 * @swagger
 * /api/masters/leaveType:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)([]), leaveType_controller_1.createLeaveType);
/**
 * @swagger
 * /api/masters/leaveType/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), leaveType_controller_1.updateLeaveType);
/**
 * @swagger
 * /api/masters/leaveType/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), leaveType_controller_1.deleteLeaveType);
