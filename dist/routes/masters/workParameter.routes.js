...
const workParameter_controller_1 = require("../../controllers/masters/taskManagement/workParameter.controller");
 ...
 */
router.get('/', workParameter_controller_1.getAllWorkParameters);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/work/:workId', workParameter_controller_1.getParametersByWorkId);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/task/:taskId', workParameter_controller_1.getParametersByTaskId);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/param/:paramId', workParameter_controller_1.getParametersByParamId);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/:id', workParameter_controller_1.getWorkParameterById);
 ...
 *         description: Internal server error
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)([]), workParameter_controller_1.createWorkParameter);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/bulk', auth_1.authenticate, (0, auth_1.authorize)([]), workParameter_controller_1.bulkCreateWorkParameters);
/**
 * @swagger
 * /api/masters/workParameter/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), workParameter_controller_1.updateWorkParameter);
/**
 * @swagger
 * /api/masters/workParameter/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)([]), workParameter_controller_1.deleteWorkParameter);
