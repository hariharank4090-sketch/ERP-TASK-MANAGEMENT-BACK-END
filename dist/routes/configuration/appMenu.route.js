...
const index_1 = __importDefault(require("../../controllers/configuration/menuManagement/index"));
const auth_1 = require("../../middleware/auth");
const AuthorizationRouter = express_1.default.Router();
const menuController = index_1.default;
// Apply authentication to all routes
AuthorizationRouter.use(auth_1.authenticate);
/**
 * @swagger
 * tags:
 ...
 */
AuthorizationRouter.get('/appMenu', auth_1.authenticate, menuController.newAppMenu);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
AuthorizationRouter.get('/newAppMenu', auth_1.authenticate, menuController.newAppMenu);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
AuthorizationRouter.get('/userRights', auth_1.authenticate, menuController.userRights);
/**
 * @swagger
 * /api/configuration/appMenu/userRights:
 *   post:
 ...
 *         description: Internal server error
 */
AuthorizationRouter.post('/userRights', auth_1.authenticate, menuController.newModifyUserRights);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
AuthorizationRouter.get('/userTypeRights', auth_1.authenticate, menuController.getNewUserTypeBasedRights);
/**
 * @swagger
 * /api/configuration/appMenu/userTypeRights:
 *   post:
 ...
 *         description: Internal server error
 */
AuthorizationRouter.post('/userTypeRights', auth_1.authenticate, menuController.newModifyUserTypeRights);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
AuthorizationRouter.get('/menuMaster', auth_1.authenticate, menuController.listMenu);
/**
 * @swagger
 * /api/configuration/appMenu/menuMaster:
 *   post:
 ...
 *         description: Internal server error
 */
AuthorizationRouter.post('/menuMaster', auth_1.authenticate, menuController.createNewMenu);
/**
 * @swagger
 * /api/configuration/appMenu/menuMaster:
 *   put:
 ...
 *         description: Internal server error
 */
AuthorizationRouter.put('/menuMaster', auth_1.authenticate, menuController.updateMenu);
