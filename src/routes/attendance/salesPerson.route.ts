...
import {
    ...
    getAttendanceStats,
} from '../../controllers/Attendace/salesperson.controller';
 ...
 *         description: Server error
 */
router.get('/last', getMyLastAttendance);
 ...
 *         description: Server error
 */
router.put('/close', closeAttendance);
 ...
 *         description: Server error
 */
router.get('/employeewise', employeewise);
 ...
 *         description: Server error
 */
router.post('/employees-by-department', getEmployeesByDepartment);
