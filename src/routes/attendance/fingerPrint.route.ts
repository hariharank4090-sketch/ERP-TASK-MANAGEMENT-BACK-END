...
import { 
    ...
    getDefaultLeaveById,
    attendanceSync
} from '../../controllers/Attendace/fingerPrintAttendance.controller';
 ...
 *         description: Server error
 */
router.get('/default-leaves', getAllDefaultLeaves);
 ...
 *         description: Server error
 */
router.get('/default-leaves/date-range', getDefaultLeavesByDateRange);
 ...
 *         description: Server error
 */
router.get('/default-leaves/:id', getDefaultLeaveById);
 ...
 *         description: Server error
 */
router.post('/fingerprintSync', attendanceSync);
