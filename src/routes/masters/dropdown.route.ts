 ...
 */
const guard = [authenticate, setCompanyDatabase, requireCompanyDB] as const;
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/projectheads', ...guard, getProjectHeadDropdown);
 ...
 *         description: Internal server error
 */
router.get('/projectStatus', ...guard, getProjectStatusDropdown);
 ...
 *         description: Internal server error
 */
router.get('/employees', ...guard, getEmployeeDropdown);
 ...
 *         description: Internal server error
 */
router.get('/employees/search', ...guard, searchEmployeesController);
 ...
 *         description: Internal server error
 */
router.get('/tasks', ...guard, getTaskDropdown);
 ...
 *         description: Internal server error
 */
router.get('/projects', ...guard, getProjectsDropdown);
 ...
 *         description: Internal server error
 */
router.get('/company', ...guard, getCompanyDropdown);
 ...
 *         description: Internal server error
 */
router.get('/all', ...guard, getAllDropdowns);
