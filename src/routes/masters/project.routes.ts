...
import {
    ...
    getProjectsByProjectHead,
    getProjectsByStatus,
    getProjectsWithNoCompany,
    getProjectsWithNoProjectHead,
    toggleProjectStatus,
 ...
 */
router.get('/statistics', authenticate, authorize([]), getProjectStatistics);
 ...
 *         description: Internal server error
 */
router.get('/status-options', authenticate, authorize([]), getStatusOptions);
 ...
 *         description: Internal server error
 */
router.get('/active', authenticate, authorize([]), getActiveProjects);
 ...
 *         description: Internal server error
 */
router.get('/no-company', authenticate, authorize([]), getProjectsWithNoCompany);
 ...
 *         description: Internal server error
 */
router.get('/no-project-head', authenticate, authorize([]), getProjectsWithNoProjectHead);
 ...
 *         description: Internal server error
 */
router.get('/company/:companyId', authenticate, authorize([]), getProjectsByCompany);
 ...
 *         description: Internal server error
 */
router.get('/project-head/:projectHeadId', authenticate, authorize([]), getProjectsByProjectHead);
 ...
 *         description: Internal server error
 */
router.get('/status/:status', authenticate, authorize([]), getProjectsByStatus);
 ...
 *         description: Internal server error
 */
router.get('/dropdown', authenticate, authorize([]), getProjectsForDropdown);
 ...
 *         description: Internal server error
 */
router.get('/', authenticate, authorize([]), getAllProjects);
 ...
 *         description: Internal server error
 */
router.get('/:id', authenticate, authorize([]), getProjectById);
 ...
 *         description: Internal server error
 */
router.put('/:id', authenticate, authorize([]), updateProject);
 ...
 *         description: Internal server error
 */
router.patch('/:id/toggle', authenticate, authorize([]), toggleProjectStatus);
 ...
 *         description: Internal server error
 */
router.patch('/:id/reactivate', authenticate,authorize([]), reactivateProject);
 ...
 *         description: Internal server error
 */
router.delete('/:id/permanent', authenticate,authorize([]), hardDeleteProject);
