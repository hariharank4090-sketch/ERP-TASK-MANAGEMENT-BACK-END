...
import {
  ...
  deleteLeave,
  getStatusOptions,
} from '../../controllers/masters/taskManagement/leave.controller';
 ...
 */
router.get('/statistics', authenticate, authorize([]), getLeaveStatistics);
 ...
 *         description: Internal server error
 */
router.get('/approve-data', authenticate, authorize([1, 2]), getApproveData);
 ...
 *         description: Internal server error
 */
router.get('/', authenticate, authorize([]), getLeaveList);
 ...
 *         description: Internal server error
 */
router.get('/:id', authenticate, authorize([]), getLeaveById);
 ...
 *         description: Internal server error
 */
router.post('/', authenticate,  authorize([]), applyLeave);
 ...
 *         description: Internal server error
 */
router.put('/', authenticate,  authorize([]), updateLeave);
 ...
 *         description: Internal server error
 */
router.delete('/', authenticate, authorize([]), deleteLeave);
