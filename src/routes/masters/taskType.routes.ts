 ...
 */
router.get('/dropdown', authenticate, authorize([]), getTaskTypeDropdown);
 ...
 *         description: Internal server error
 */
router.get('/statistics', authenticate, authorize([]), getTaskTypeStatistics);
 ...
 *         description: Internal server error
 */
router.get('/active', authenticate, authorize([]), getActiveTaskTypes);
 ...
 *         description: Internal server error
 */
router.get('/project/:projectId', authenticate, authorize([]), getTaskTypesByProjectId);
 ...
 *         description: Internal server error
 */
router.get('/task/:taskId', authenticate, authorize([]), getTaskTypesByTaskId);
 ...
 *         description: Internal server error
 */
router.get('/', authenticate, authorize([]), getAllTaskTypes);
 ...
 *         description: Internal server error
 */
router.get('/:id', authenticate, authorize([]), getTaskTypeById);
 ...
 *         description: Internal server error
 */
router.post('/', authenticate, authorize([]), createTaskType);
 ...
 *         description: Internal server error
 */
router.put('/:id', authenticate, authorize([]), updateTaskType);
 ...
 *         description: Internal server error
 */
router.delete('/:id', authenticate, authorize([]), deleteTaskType);
 ...
 *         description: Internal server error
 */
router.patch('/:id/toggle', authenticate, authorize([]), toggleTaskTypeStatus);
 ...
 *         description: Internal server error
 */
router.patch('/:id/restore', authenticate, authorize([]), restoreTaskType);
 ...
 *         description: Internal server error
 */
router.delete('/:id/permanent', authenticate, authorize([]), hardDeleteTaskType);
