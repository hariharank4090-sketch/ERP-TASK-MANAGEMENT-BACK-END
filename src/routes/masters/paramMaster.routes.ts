...
import {
    ...
    getParamMastersByCompanyId,
    restoreParamMaster,
    hardDeleteParamMaster,
    getParamMasterStatistics
 ...
 */
router.get('/statistics', authenticate, authorize([]), getParamMasterStatistics);
 ...
 *         description: Internal server error
 */
router.get('/active', authenticate, authorize([]), getAllActiveParamMasters);
 ...
 *         description: Internal server error
 */
router.get('/company/:companyId', authenticate, authorize([]), getParamMastersByCompanyId);
 ...
 *         description: Internal server error
 */
router.get('/', authenticate, authorize([]), getAllParamMasters);
 ...
 *         description: Internal server error
 */
router.get('/:id', authenticate, authorize([]), getParamMasterById);
 ...
 *         description: Internal server error
 */
router.post('/', authenticate,  authorize([]), createParamMaster);
 ...
 *         description: Internal server error
 */
router.put('/:id', authenticate,  authorize([]), updateParamMaster);
 ...
 *         description: Internal server error
 */
router.delete('/:id', authenticate,  authorize([]), deleteParamMaster);
 ...
 *         description: Internal server error
 */
router.patch('/:id/restore', authenticate,  authorize([]), restoreParamMaster);
 ...
 *         description: Internal server error
 */
router.delete('/:id/permanent', authenticate,  authorize([]), hardDeleteParamMaster);
