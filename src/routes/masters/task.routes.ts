 ...
 */
router.get('/', authenticate, authorize([]), getAllTasks);
 ...
 *         description: Internal server error
 */
router.get('/no-company', authenticate, authorize([]), getTasksWithNoCompany);
 ...
 *         description: Internal server error
 */
router.get('/no-project', authenticate, authorize([]), getTasksWithNoProject);
 ...
 *         description: Internal server error
 */
router.get('/project/:projectId', authenticate, authorize([]), getTasksByProject);
 ...
 *         description: Internal server error
 */
router.get('/company/:companyId', authenticate, authorize([]), getTasksByCompany);
 ...
 *         description: Internal server error
 */
router.get('/task-group/:taskGroupId', authenticate, authorize([]), getTasksByTaskGroup);
 ...
 *         description: Internal server error
 */
router.get('/:taskId/schedules', authenticate, authorize([]), getTaskSchedules);
 ...
 *         description: Internal server error
 */
router.get('/:id', authenticate, authorize([]), getTaskById);
 ...
 *         description: Internal server error
 */
router.post('/', authenticate,authorize([]), createTask);
 ...
 *         description: Internal server error
 */
router.put('/:id', authenticate, authorize([]), updateTask);
