...
export class Company_Master extends Model<CompanyAttributes, CompanyCreationAttributes> implements CompanyAttributes {
...
export function initCompanyModel(sequelize: Sequelize): typeof Company_Master {
    Company_Master.init(
        {
            Company_id: {
